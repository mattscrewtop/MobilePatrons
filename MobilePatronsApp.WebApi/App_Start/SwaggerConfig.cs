...
namespace MobilePatronsApp.WebApi
{
	public class SwaggerConfig
	{
				...
				.EnableSwagger(c =>
					{
						...
						//
						c.SingleApiVersion("v1", "MobilePatronsApp.WebApi");
		...
		{
			return System.String.Format(@"{0}\bin\MobilePatronsApp.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
		}	
	}
